import os
from .error_exception.error_exception import InvalidWorkspacePathError
from core.helper.error_exception.error_exception import InvalidWorkspacePathError
...
def find_project_root(filename=None):
    ...
    if "WORKSPACE" in os.environ:
        ...
        raise InvalidWorkspacePathError(
            "WORKSPACE does not point to a valid directory"
        )
